        ...
        <div className={`grid ${gridCols} gap-6`}>
          {items.map((item, index) => (
            <motion.div
              ...
              className="flex items-start gap-4 p-6 rounded-2xl bg-white dark:bg-[#6b7280] border-4 border-[#E07A47] hover:border-[#D96835] transition-all duration-300 hover:shadow-xl hover:shadow-[#E07A47]/20"
            >
