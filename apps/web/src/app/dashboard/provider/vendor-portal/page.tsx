        ...
        <div className="max-w-7xl px-6 py-8 mx-auto">
          ...
          <div className="grid gap-6">
            {filteredContracts.map((contract) => (
              <Card key={contract.id} className="border-4 border-[#E07A47] hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  <div className="grid lg:grid-cols-12 gap-6">
                    ...
                    <div className="lg:col-span-5">
                      <div className="flex items-start gap-3 mb-4">
                        ...
                        <div className="flex-1">
                          <h3 className="text-2xl font-black mb-1">{contract.propertyName}</h3>
                        ...
                        {contract.rating && (
                          <div className="flex justify-between">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span className="font-bold">{contract.rating}</span>
                            </div>
                          </div>
                        )}
                      </div>
                    ...
                    <div className="lg:col-span-4">
                      <h4 className="font-bold text-sm mb-3">Services Covered</h4>
