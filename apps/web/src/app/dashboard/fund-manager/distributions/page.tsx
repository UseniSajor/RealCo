      ...
      <div className="container max-w-7xl px-6 py-8 mx-auto">
        ...
        <div className="grid gap-6">
          {filteredDistributions.map((distribution) => (
            <Card key={distribution.id} className="border-4 border-[#E07A47] dark:bg-[#6b7280] hover:shadow-lg transition-shadow">
                ...
                <div className="grid lg:grid-cols-12 gap-6">
                  ...
                  <div className="lg:col-span-4">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="text-2xl font-black mb-2 dark:text-white">{distribution.offering}</h3>
                    ...
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-muted-foreground dark:text-white/70">Distribution Date:</span>
                        <span className="font-bold dark:text-white">{new Date(distribution.distributionDate).toLocaleDateString()}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground dark:text-white/70">Investors:</span>
                        <span className="font-bold dark:text-white">{distribution.investorCount}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground dark:text-white/70">Avg per Investor:</span>
                        <span className="font-bold dark:text-white">${distribution.avgDistribution.toLocaleString()}</span>
                      </div>
                      {distribution.processedDate && (
                        <div className="flex justify-between">
                          <span className="text-muted-foreground dark:text-white/70">Processed:</span>
                  ...
                  <div className="lg:col-span-5">
                    <h4 className="font-bold text-lg mb-4 dark:text-white">Waterfall Distribution</h4>
                    <div className="space-y-3">
                      <div className="bg-muted/50 dark:bg-slate-700 rounded-lg p-4">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm font-semibold dark:text-white">1. Return of Capital</span>
                          <span className="text-lg font-black dark:text-white">${(distribution.waterfall.returnOfCapital / 1000).toFixed(0)}K</span>
                        </div>
                      ...
                      <div className="bg-muted/50 dark:bg-slate-700 rounded-lg p-4">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm font-semibold dark:text-white">2. Preferred Return (8%)</span>
                      ...
                      <div className="bg-muted/50 dark:bg-slate-700 rounded-lg p-4">
                        <div className="flex justify-between items-center mb-2">
                          <span className="text-sm font-semibold dark:text-white">3. Profit Split (70/30)</span>
                      ...
                      {distribution.status === 'pending' && (
                        <div className="bg-yellow-50 dark:bg-yellow-900/20 border-2 border-yellow-400 rounded-lg p-3 mb-4">
                          <p className="text-xs font-semibold text-yellow-800 dark:text-yellow-200">
                            ⚠️ Awaiting approval and scheduling
                          </p>
                        </div>
                      )}

                      {distribution.status === 'scheduled' && (
                        <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-400 rounded-lg p-3 mb-4">
        ...
        <Card className="border-4 border-[#56CCF2] dark:bg-[#6b7280] mt-8">
          <CardHeader>
            <CardTitle className="text-2xl dark:text-white">Distribution Waterfall Structure</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold dark:text-white">Tier 1: Return of Capital</h4>
                </div>
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold dark:text-white">Tier 2: Preferred Return</h4>
                </div>
                <p className="text-sm text-muted-foreground dark:text-white/70">
              ...
              <div>
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="font-bold dark:text-white">Tier 3: Profit Split</h4>
                </div>
                <p className="text-sm text-muted-foreground dark:text-white/70">
