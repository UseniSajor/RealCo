        ...
        <div className="container max-w-7xl px-6 py-8 mx-auto">
          ...
          <div className="grid gap-6">
            {filteredCommunications.map((comm) => (
              <Card key={comm.id} className="border-4 border-[#E07A47] bg-white hover:shadow-lg transition-shadow">
                    ...
                    <div className="lg:col-span-5">
                      <div className="flex items-start gap-3 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <h3 className="text-xl font-black mb-2">{comm.subject}</h3>
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-bold">{comm.recipientCount} investors</span>
                        </div>
                        {comm.sentDate && (
                          <div className="flex justify-between">
                          ...
                          <>
                            ...
                            {comm.location && (
                              <div className="flex justify-between">
                                ...
                                <span className="font-bold">{comm.location}</span>
                              </div>
                            )}
                          </>
                        )}
                    ...
                    <div className="lg:col-span-4">
                      ...
                      {comm.type === 'event' && (
                        <div className="space-y-4">
                          <div className="bg-[#56CCF2]/10 rounded-lg p-4 border-2 border-[#56CCF2]">
                          ...
                          <div className="bg-muted/50 rounded-lg p-4">
                            ...
                            <div className="space-y-2 text-sm">
                              <div className="flex items-center gap-2">
                                ...
                                <span>{comm.eventDate && new Date(comm.eventDate).toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</span>
                              </div>
                              {comm.location && (
                                <div className="flex items-center gap-2">
          ...
          <Card className="border-4 border-[#56CCF2] bg-white mt-8">
            <CardHeader>
              <CardTitle className="text-2xl">Communication Templates</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid md:grid-cols-4 gap-4">
                {[
                  ...
                  <Button key={template.title} variant="outline" className="h-auto flex-col items-start p-4 border-2 border-[#E07A47] hover:bg-muted/50">
                    ...
                    <span className="font-bold text-left">{template.title}</span>
                    <span className="text-xs text-muted-foreground text-left mt-1">{template.desc}</span>
                  </Button>
                ))}
              </div>
            </CardContent>
